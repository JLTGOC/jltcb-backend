...
class QuotationPolicy
{
    ...
    {
        return $user->hasRole(['Client', 'Account Specialist', 'Lead Account Specialist', 'Operations', 'Client Success']);
    }
    ...
    {
        return $user->hasRole(['Client', 'Lead Account Specialist', 'Account Specialist', 'Client Success']);
    }
    ...
    {
        return $user->id === $quotation->as_id || $user->hasRole(['Lead Account Specialist', 'Client Success']);
    }
