...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->cleanupSeederFiles('articles');
        ...
        $articles = [
            [
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[0]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[1]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[2]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[3]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[4]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[5]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[6]),
            ],
            [
                'user_id' => 3,
                ...
                'image_url' => $this->copySeederFile('articles', $imageFiles[7]),
            ],
        ];
